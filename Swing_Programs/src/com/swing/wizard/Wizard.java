...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
	...
	private void initComponents() {
		...
		backButton = new JButton(new ImageIcon("com/swing/wizard/backIcon.gif"));
	...
	private static Object getImage(String name) {
		...
		try {
			Class c = Class.forName("com.swing.wizard.Wizard");
	...
	static {
		...
		try {
			...
			PropertyResourceBundle resources = (PropertyResourceBundle) ResourceBundle
					.getBundle("com.swing.wizard.wizard");
			...
			BACK_ICON = new ImageIcon((URL) getImage((String) (resources
					.getObject("backButtonIcon"))));
			NEXT_ICON = new ImageIcon((URL) getImage((String) (resources
					.getObject("nextButtonIcon"))));
			CANCEL_ICON = new ImageIcon((URL) getImage((String) (resources
					.getObject("cancelButtonIcon"))));
			FINISH_ICON = new ImageIcon((URL) getImage((String) (resources
